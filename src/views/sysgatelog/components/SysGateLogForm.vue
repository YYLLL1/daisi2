      ...
      <a-row>
        <a-col :span="24">
          <a-form-item label="闸机状态" v-bind="validateInfos.gateStatus">
            <j-dict-select-tag v-model:value="formData.gateStatus" dictCode="rent_cabinet_status" placeholder="请选择闸机状态" :disabled="props.disabled" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="闸机编号" v-bind="validateInfos.lockerNo">
            <a-input v-model:value="formData.lockerNo" placeholder="请输入闸机编号" :disabled="props.disabled" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item label="闸机订单号" v-bind="validateInfos.gateOrderCode">
            <a-input v-model:value="formData.gateOrderCode" placeholder="请输入闸机订单号" :disabled="props.disabled" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="进出闸方式" v-bind="validateInfos.gateType">
            <j-dict-select-tag v-model:value="formData.gateType" dictCode="open_cabinet_type" placeholder="请选择进出闸方式" :disabled="props.disabled" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
