<template>
  <div class="ly-container">
    ...
    <!-- 表单区域 -->
    <SysCabinetLogModal ref="registerModal" @success="handleSuccess" />
  </div>
</template>
...
<script lang="ts" name="syscabinetlog-sysCabinetLog" setup>
  ...
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './SysCabinetLog.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import SysCabinetLogModal from './components/SysCabinetLogModal.vue';
