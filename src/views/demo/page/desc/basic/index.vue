...
<script lang="ts">
  ...
  import { refundSchema, refundData, personSchema, personData, refundTableSchema, refundTimeTableSchema, refundTableData, refundTimeTableData } from '/@/views/demo/page/desc/basic/data';
