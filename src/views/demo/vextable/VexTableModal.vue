      ...
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="客户信息" key="1">
          ...
          >
            ...
            <vxe-column field="name" title="客户名" sortable :edit-render="{ name: 'input', defaultValue: '' }" />
            <vxe-column field="sex" title="性别" :edit-render="{ name: '$select', options: sexList }" />
            <vxe-column field="idcard" title="身份证" sortable :edit-render="{ name: 'input', defaultValue: '' }" />
            <vxe-column field="telphone" title="手机" sortable :edit-render="{ name: 'input', defaultValue: '' }" />
          </vxe-table>
        </a-tab-pane>
